...
<<<<<<< HEAD
    ...
    <Section delay={0.1}>
      ...
      <li>
        Many of my friends said this is so true about me :{' '}
    ...
    <Section delay={0.1}>
      ...
      <p>
        A III-Year student pursing Computer Science and Engineering at Ecole
        Centrale School of Engineering, Mahindra University.
        <br /> <br />
        Currently, working with Farming Revolution GmbH (Deepfield Robotics,
        Bosch) on a Research Project on Vision Based Laser Targeting System for
        Weeding in Mobile Robots.
        <br />
        <br />
        Previously, worked on Laser Weeding for CNC-based farmbot with an
        open-source organization called FarmBot Inc.
        <br />
        <br />I was part of World Robotics Olympiad as Team UAE in 2018 ,FIRST
        Tech Challenge and Judge at FIRST Lego League in 2019/2020 and World
        Robotics Olympiad in 2021.
      </p>
    </Section>
    ...
    <Section>
      ...
      <p>
        🌱 20-year-old CS Student trying to build/research on robots in the
        field of Agriculture and turn into Agritech Startup with RaaS 🤖
        <p />
      </p>
      <br></br>
      <p>
        ⚡ Currently, working with Farming Revolution GmbH (Deepfield Robotics,
        Bosch) on a Research Project on Laser Weeding in Moblie Robots using
        Pan-Tilt System in Mahindra University ☘️
      </p>
      <br></br>
      <p>
        😅 <u>Up to this point, best regret</u> :
      </p>
      <br></br>
      <li>
        Bunking classes in High School to work on Cable Suspended Robots for
        Agriculture in the robotics lab led me to win the National Robotics
        Olympiad 2018, represent the UAE, and ranked 14th place in the World
        Finals in Thailand 2018 🌿
      </li>
      <br></br>
      <li>
        Rejected abroad university acceptance letters to study in India, which
        could be the best place to work on agriculture field in the world (I
        feel) 🧑‍🏭
      </li>
      <br></br>
    ...
    <Section delay={0.1}>
      ...
      <li>
        {<Icon as={IoLaptopOutline} />} Custom PC Build with i5-8500K, 16GB
        Cosiar Vengence RGB RAM , MSI GTX1050Ti 4GB, Factual Design Case, 650W
        PSU, MSI Gaming Mouse and 60% Mechanical Keyboard
      </li>
      <li>
        {<Icon as={IoLaptop} />} Asus ROG Zephyrus M16 with i9-11800H, 32GB RAM,
        16:10 165Hz , RTX 3070 8GB, 2TB SSD
      </li>
      <li>
        {<Icon as={IoTvOutline} />} Raspberry Pi Model B+, Arduino UNO, Arduino
        MEGA, and Nvidia Jetson Nano
      </li>
    </Section>
